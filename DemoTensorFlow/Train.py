...
# label_pred_out , correct_prediction_out,accuracy_out = sess.run([label_pred,correct_prediction,accuracy], feed_dict={image_input: list_image_test, label_input: LabelsOneHot_test})
#
# print(label_pred_out)
#
