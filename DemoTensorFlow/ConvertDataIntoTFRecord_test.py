...
tf.app.flags.DEFINE_string('test_directory', './faces94/test',
                           'Training data directory')
tf.app.flags.DEFINE_string('output_directory', './faces94/test/',
...
tf.app.flags.DEFINE_string('labels_file', './faces94/label.txt', 'Labels file')
