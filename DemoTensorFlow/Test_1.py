...
#
# label_input = sess.graph.get_tensor_by_name('label_input:0')
#
# cost = sess.graph.get_tensor_by_name('loss:0')
#
...
print("accuracy : "+str(accuracy_output_step)+" - loss :"+str(cost_output))